      ...
      <label>TPS:</label>
        <div class="table-responsive">        
          <table class="table">
            ...
            <?php
            $i=0;
              $result=mysqli_query($con,"SELECT * FROM TPSScores WHERE UserId='$userId' AND Done=0");
...
//					$status="--";
                ...
                echo "<td>$Topic</td>";
				 //echo "<td>$status</td>";
                echo "<td><a href=detailedReview.php?id=$ScoreId&type=1>View</a></td>";
                echo "</tr>";
        ...
        <div class="table-responsive">        
          <table class="table">
            ...
            <?php
            $i=0;
              $result=mysqli_query($con,"SELECT * FROM PIScores WHERE UserId='$userId' AND Done=0");
              while($row=mysqli_fetch_array($result))
              {
                $i++;
                $ReviewerId=$row['ReviewerId'];
...
//					$status1="--";
                ...
                echo "<td>$Topic</td>";
				 //echo "<td>$status1</td>";
                echo "<td><a href=detailedReview.php?id=$ScoreId&type=2>View</a></td>";
                echo "</tr>";
