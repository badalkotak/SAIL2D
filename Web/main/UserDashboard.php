...
<html>
  ...
  <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="createActivity.php"><image src="../Resources/icons/create.png" height=100 width=88></image><br><h4>Create Activity</h4>
        </a></center>
            </div>
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="viewActivity.php"><image src="../Resources/icons/newspaper.png" height=100 width=88></image><br><h4>View / Review Activity</h4></a></center>
            </div>
			
			<div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="viewReview.php"><image src="../Resources/icons/review.png" height=100 width=88></image><br><h4>Pending Reviews</h4>
        </a></center>
            </div>
            
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="givenReviews.php"><image src="../Resources/icons/review.png" height=100 width=88></image><br><h4>Review Provided</h4>
        </a></center>
            </div>
			
			<div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="disagree.php"><image src="../Resources/icons/hands.png" height=100 width=88></image><br><h4>Disagreement Resolver</h4>
        </a></center>
            </div>

<div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="PendingRatings.php"><image src="../Resources/icons/pending.png" height=100 width=88></image><br><h4>Pending Ratings</h4>
        </a></center>
            </div>
...
<?
$check=mysqli_query($con,"SELECT * FROM PendingRating WHERE TakeRating='$userId'");
if($c=mysqli_fetch_array($check))
{
	echo "<script>alert('You have some pending ratings, Please complete it in: Pending Ratings Section');</script>";
}
?>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
