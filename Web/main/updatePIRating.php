...
<h4><label>Original Rating:</label></h4>
          ...
          <table class="table">
            ...
            <?php
            $count=mysqli_query($con,"SELECT COUNT(ScoreId) FROM UpdatePIScores WHERE PIId='$id'");
          ...
          <table class="table">
            ...
            <tbody>
              ...
              $result=mysqli_query($con,"SELECT * FROM UpdatePIScores WHERE PIId='$id'");
              while($row=mysqli_fetch_array($result))
              {
                $i++;
                $s1=$row['Score1'];
...
else
{
  echo '<h4><label>No Updates!</label></h4>';
        ...
        <div class="box box-default collapsed-box box-solid">
          ...
          <div class="box-body">
            <div class="table-responsive">  
            <?echo "<form action=activityUpdateRating.php?type=2&id=$id method=post>";?>
              <table class="table">
                <thead>
                  <tr>
                    <th>Sr No.</th>
