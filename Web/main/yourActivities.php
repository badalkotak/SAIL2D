      ...
      <label>TPS:</label>
        <div class="table-responsive">        
          <table class="table">
            ...
            <?php
            $i=0;
              $result=mysqli_query($con,"SELECT * FROM TPS WHERE User='$userId'");
...
//					$status="--";
                ...
                echo "<td>$Topic</td>";
				 //echo "<td>$status</td>";
                echo "<td><a href=detailedActivity.php?id=$TPSId&type=1>View</a></td>";
                echo "</tr>";
        ...
        <div class="table-responsive">        
          <table class="table">
            ...
            <?php
            $i=0;
              $result=mysqli_query($con,"SELECT * FROM PI WHERE User='$userId'");
              while($row=mysqli_fetch_array($result))
              {
                $i++;
                $ReviewerId=$row['ReviewerId'];
...
//					$status1="--";
                ...
                echo "<td>$Topic</td>";
				 //echo "<td>$status1</td>";
                echo "<td><a href=detailedActivity.php?id=$PIId&type=2>View</a></td>";
                echo "</tr>";
