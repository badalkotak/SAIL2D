      ...
      <label>TPS:</label>
        <div class="table-responsive">        
          <table class="table">
            ...
            <?php
            $i=0;
              $result=mysqli_query($con,"SELECT * FROM TPSScores WHERE UserId='$userId'");
...
//					$status="--";
                ...
                echo "<td>$Topic</td>";
				 //echo "<td>$status</td>";
                echo "<td><a href=UpdatedScore.php?id=$ScoreId&type=1>View</a></td>";
                echo "</tr>";
        ...
        <div class="table-responsive">        
          <table class="table">
            ...
            <?php
            $i=0;
              $result=mysqli_query($con,"SELECT * FROM PIScores WHERE UserId='$userId'");
              while($row=mysqli_fetch_array($result))
              {
                $i++;
                $ReviewerId=$row['ReviewerId'];
