		...
		<div class="table-responsive">  
              <table class="table">
                ...
                <tbody>
                  <?php
				  $i=0;
				  $getPending=mysqli_query($con,"SELECT * FROM PendingRating WHERE TakeRating='$userId'");
				  while($get=mysqli_fetch_array($getPending))
				  {
					  $giveRating=$get['UserId'];
					  $getName=mysqli_query($con,"SELECT UserFirstName, UserLastName,UserId FROM UserDetails WHERE UserId='$giveRating'");
                while($row=mysqli_fetch_array($getName))
                {
				  ...
				  if($type==1)
				  {
					  $getActivity=mysqli_query($con,"SELECT * FROM TPSScore WHERE ScoreId='$ScoreId'");
					  while($getAct=mysqli_fetch_array($getActivity))
					  {
						  $TPSId=$getAct['TPSId'];
					  }
				  }
				  ...
				  {
					$getActivity=mysqli_query($con,"SELECT * FROM PIScore WHERE ScoreId='$ScoreId'");
					  while($getAct=mysqli_fetch_array($getActivity))
					  {
						  $PIId=$getAct['PIId'];
					  }
				  ...
				  echo "<td>$i</td>";
				  echo "<td>$Username</td>";
				  echo "<td><a href=UpdatedPI.php?id=$ScoreId>View</a></td>";
				  echo "<td><a href=agreeReview.php?type=$type&id=$ScoreId&pr=1>Rate</a>";
				  echo "</tr>";
				  }
				  ?>
                </tbody>
